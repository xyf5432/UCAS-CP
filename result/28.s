...
.main_entry:
  ...
  addi t1, t1, 10
  li   t2, 0
  ble t0, t1, .main_skip94483834319536
  li   t2, 1
.main_skip94483834319536:
  sw   t2, -60(s0)
  #   br i1 %cmptmp, label %and.rhs, label %and.end
  lw   t0, -60(s0)
  beqz t0, .entry_br_false_path_94483834319928
  j .main_and.rhs
.entry_br_false_path_94483834319928:
  lui  t2, 0
  sw   t2, -76(s0)
  j .main_and.end
.main_and.rhs:
  ...
  lui  t1, 0
  li   t2, 0
  beq t0, t1, .main_skip94483834320368
  li   t2, 1
.main_skip94483834320368:
  sw   t2, -72(s0)
  #   br label %and.end
  lw   t2, -72(s0)
  sw   t2, -76(s0)
...
.main_and.end:
  ...
  lw   t0, -76(s0)
  beqz t0, .and.end_br_false_path_94483834321592
  j .main_if.then
.and.end_br_false_path_94483834321592:
  j .main_if.else
.main_if.then:
  #   store i32 1, i32* %i
  addi t1, s0, -48
...
.main_if.merge:
  ...
  addi t1, t1, 11
  li   t2, 0
  ble t0, t1, .main_skip94483834322624
  li   t2, 1
.main_skip94483834322624:
  sw   t2, -88(s0)
  #   br i1 %cmptmp5, label %and.rhs6, label %and.end7
  lw   t0, -88(s0)
  beqz t0, .if.merge_br_false_path_94483834323048
  j .main_and.rhs6
.if.merge_br_false_path_94483834323048:
  lui  t2, 0
  sw   t2, -104(s0)
  j .main_and.end7
.main_and.rhs6:
  ...
  lui  t1, 0
  li   t2, 0
  beq t0, t1, .main_skip94483834323536
  li   t2, 1
.main_skip94483834323536:
  sw   t2, -100(s0)
  #   br label %and.end7
  lw   t2, -100(s0)
  sw   t2, -104(s0)
...
.main_and.end7:
  ...
  lw   t0, -104(s0)
  beqz t0, .and.end7_br_false_path_94483834325208
  j .main_if.then12
.and.end7_br_false_path_94483834325208:
  j .main_if.else13
.main_if.then12:
  #   store i32 1, i32* %i
  addi t1, s0, -48
...
.main_if.merge14:
  ...
  addi t1, t1, 99
  li   t2, 0
  bgt t0, t1, .main_skip94483834328272
  li   t2, 1
.main_skip94483834328272:
  sw   t2, -116(s0)
  #   br i1 %cmptmp17, label %or.end, label %or.rhs
  lw   t0, -116(s0)
  beqz t0, .if.merge14_br_false_path_94483834328648
  lui  t2, 0
  addi t2, t2, -1
  sw   t2, -132(s0)
  j .main_or.end
.if.merge14_br_false_path_94483834328648:
  j .main_or.rhs
.main_or.rhs:
  ...
  lui  t1, 0
  li   t2, 0
  beq t0, t1, .main_skip94483834329136
  li   t2, 1
.main_skip94483834329136:
  sw   t2, -128(s0)
  #   br label %or.end
  lw   t2, -128(s0)
  sw   t2, -132(s0)
...
.main_or.end:
  ...
  lw   t0, -132(s0)
  beqz t0, .or.end_br_false_path_94483834330056
  j .main_if.then21
.or.end_br_false_path_94483834330056:
  j .main_if.else22
.main_if.then21:
  #   store i32 1, i32* %i
  addi t1, s0, -48
...
.main_if.merge23:
  ...
  addi t1, t1, 100
  li   t2, 0
  bgt t0, t1, .main_skip94483834331056
  li   t2, 1
.main_skip94483834331056:
  sw   t2, -144(s0)
  #   br i1 %cmptmp26, label %or.end28, label %or.rhs27
  lw   t0, -144(s0)
  beqz t0, .if.merge23_br_false_path_94483834331496
  lui  t2, 0
  addi t2, t2, -1
  sw   t2, -160(s0)
  j .main_or.end28
.if.merge23_br_false_path_94483834331496:
  j .main_or.rhs27
.main_or.rhs27:
  ...
  lui  t1, 0
  li   t2, 0
  beq t0, t1, .main_skip94483834331952
  li   t2, 1
.main_skip94483834331952:
  sw   t2, -156(s0)
  #   br label %or.end28
  lw   t2, -156(s0)
  sw   t2, -160(s0)
...
.main_or.end28:
  ...
  lw   t0, -160(s0)
  beqz t0, .or.end28_br_false_path_94483834334392
  j .main_if.then33
.or.end28_br_false_path_94483834334392:
  j .main_if.else34
.main_if.then33:
  #   store i32 1, i32* %i
  addi t1, s0, -48
...
.main_if.merge35:
  ...
  lui  t1, 0
  li   t2, 0
  beq t0, t1, .main_skip94483834335136
  li   t2, 1
.main_skip94483834335136:
  sw   t2, -168(s0)
  #   %logicalnot = icmp eq i1 %tobool37, false
  lw   t0, -168(s0)
  lui  t1, 0
  li   t2, 0
  bne t0, t1, .main_skip94483834335296
  li   t2, 1
.main_skip94483834335296:
  sw   t2, -172(s0)
  #   br i1 %logicalnot, label %and.rhs38, label %and.end39
  lw   t0, -172(s0)
  beqz t0, .if.merge35_br_false_path_94483834335736
  j .main_and.rhs38
.if.merge35_br_false_path_94483834335736:
  lui  t2, 0
  sw   t2, -184(s0)
  j .main_and.end39
.main_and.rhs38:
  ...
  lui  t1, 0
  li   t2, 0
  beq t0, t1, .main_skip94483834336032
  li   t2, 1
.main_skip94483834336032:
  sw   t2, -180(s0)
  #   br label %and.end39
  lw   t2, -180(s0)
  sw   t2, -184(s0)
...
.main_and.end39:
  ...
  lw   t0, -184(s0)
  beqz t0, .and.end39_br_false_path_94483834336904
  j .main_if.then43
.and.end39_br_false_path_94483834336904:
  j .main_if.else44
.main_if.then43:
  #   store i32 1, i32* %i
  addi t1, s0, -48
